...
class FileManager:
    ...
    def configure_window(self):
        ...
        self.top_frame.configure(bg="#0000FF")
        self.bottom_frame.configure(bg="#0000FF")
        self.top_frame.pack(fill=BOTH)
        self.bottom_frame.pack(fill=BOTH)
        self.file_list.pack(side=LEFT, padx=10, pady=10)
        self.file_list.configure(font=Font(size=9, weight="bold"), bg="#C0C0C0", fg="#FFFFFF",
                                 selectbackground="#FFFFFF", selectforeground="#000000")
        self.file_content.pack(side=RIGHT, padx=10, pady=10)
        self.file_content.configure(font=Font(size=9, weight="bold"), bg="#C0C0C0", fg="#FFFFFF",
                                    selectbackground="#FFFFFF", selectforeground="#000000")
        self.label.pack(side=TOP, padx=10)
        self.label.configure(font=Font(size=9, weight="bold"), bg="#C0C0C0", fg="#FFFFFF")
        self.console.pack(side=TOP, padx=10, pady=2)
        self.console.configure(font=Font(size=9, weight="bold"), bg="#C0C0C0", fg="#FFFFFF")
